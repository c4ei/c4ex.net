...
def get_withdrawal_requests_to_process(currencies: list, blockchain_currency=''):
    ...
    for cur in currencies:
        if cur in ERC20_CURRENCIES or cur in TRC20_CURRENCIES or cur in BEP20_CURRENCIES or cur in ERC20_MATIC_CURRENCIES or cur in ERC20_AAH_CURRENCIES or cur in ERC20_KLAY_CURRENCIES:
            tokens.append(cur)
        else:
            coins.append(cur)
