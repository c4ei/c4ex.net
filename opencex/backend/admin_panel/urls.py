...
from admin_panel.views import admin_withdrawal_request_approve, admin_eth_withdrawal_request_approve, make_topup, \
    ...
    admin_aah_withdrawal_request_approve , admin_c4ei_withdrawal_request_approve #, admin_klay_withdrawal_request_approve
...
urls = [
    ...
    # path(
    #     f'withdrawal_request/approve/klay/',
    #     admin_klay_withdrawal_request_approve,
    #     name='admin_withdrawal_request_approve_klay'
    # ),
    path(
        f'withdrawal_request/approve/c4ei/',
        admin_c4ei_withdrawal_request_approve,
        name='admin_withdrawal_request_approve_c4ei'
    ),
    path(
       f'make/top-up/',
       make_topup,
