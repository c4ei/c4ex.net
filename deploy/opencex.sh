...
TELEGRAM=c4eiAirdrop
FACEBOOK=
TWITTER=c4ei_net
LINKEDIN=
LOGO="https://i.ibb.co/xJKytKh/c4exlogo.png"
...
=======================================================================================
 STEP 7-1 of 12. C4EX BLOCKCHAIN, AAH and USDT AAH SUPPORT. (optional)
=======================================================================================

You can set ENABLED_AAH: False or leave it blank to turn it off.

C4EXSCAN_KEY* - used for the C4ex blockchain data
AAH_SAFE_ADDR* - C4ex address. All AAH and ERC-20 (AAH) deposits go there
---------------------------------------------------------------------------------------
...
echo -n "ENABLED_AAH (True/False): "
read ENABLED_AAH
export ENABLED_AAH
COMMON_TASKS_AAH=false
export COMMON_TASKS_AAH
if [ "$ENABLED_AAH" = "True" ]; then

COMMON_TASKS_AAH=true
export COMMON_TASKS_AAH
...
echo -n "AAH_SAFE_ADDR*: "
read AAH_SAFE_ADDR
export AAH_SAFE_ADDR
...
=======================================================================================
 STEP 7-2 of 12. CYPRESS BLOCKCHAIN, KLAY and USDT KLAY SUPPORT. (optional)
=======================================================================================

You can set ENABLED_KLAY: False or leave it blank to turn it off.

CYPRESSSCAN_KEY* - used for the Cypress blockchain data
KLAY_SAFE_ADDR* - Cypress address. All KLAY and ERC-20 (KLAY) deposits go there
---------------------------------------------------------------------------------------
...
echo -n "ENABLED_KLAY (True/False): "
read ENABLED_KLAY
export ENABLED_KLAY
COMMON_TASKS_KLAY=false
export COMMON_TASKS_KLAY
if [ "$ENABLED_KLAY" = "True" ]; then

COMMON_TASKS_KLAY=true
export COMMON_TASKS_KLAY

echo -n "CYPRESSSCAN_KEY*: "
read CYPRESSSCAN_KEY
export CYPRESSSCAN_KEY

echo -n "KLAY_SAFE_ADDR*: "
read KLAY_SAFE_ADDR
export KLAY_SAFE_ADDR
...
=======================================================================================
 STEP 7-3 of 12. CFEI BLOCKCHAIN, C4EI and USDT C4EI SUPPORT. (optional)
=======================================================================================

You can set ENABLED_C4EI: False or leave it blank to turn it off.

CFEISCAN_KEY* - used for the Cfei blockchain data
C4EI_SAFE_ADDR* - Cfei address. All C4EI and ERC-20 (C4EI) deposits go there
---------------------------------------------------------------------------------------
...
echo -n "ENABLED_C4EI (True/False): "
read ENABLED_C4EI
export ENABLED_C4EI
COMMON_TASKS_C4EI=false
export COMMON_TASKS_C4EI
if [ "$ENABLED_C4EI" = "True" ]; then

COMMON_TASKS_C4EI=true
export COMMON_TASKS_C4EI
...
echo -n "C4EI_SAFE_ADDR*: "
read C4EI_SAFE_ADDR
export C4EI_SAFE_ADDR
...
#     entrypoint: tail -f /dev/null
    ...
    opencex-aah-blocks:
     container_name: opencex-aah-blocks
     image: opencex:latest
     command: bash -c "celery -A exchange worker -l info -n aah_new_blocks -Q aah_new_blocks -c 1 "
     restart: always
     volumes:
      - /app/opencex/backend:/app
     networks:
    ...
    opencex-klay-blocks:
     container_name: opencex-klay-blocks
     image: opencex:latest
     command: bash -c "celery -A exchange worker -l info -n klay_new_blocks -Q klay_new_blocks -c 1 "
     restart: always
     volumes:
      - /app/opencex/backend:/app
     networks:
    ...
    opencex-deposits:
     ...
     image: opencex:latest
     command: bash -c "celery -A exchange worker -l info -n deposits -Q trx_deposits,bnb_deposits,eth_deposits,matic_deposits,aah_deposits,klay_deposits -c 1 "
     restart: always
     volumes:
      - /app/opencex/backend:/app
     networks:
    ...
    opencex-payouts:
     ...
     image: opencex:latest
     command: bash -c "celery -A exchange worker -l info -n payouts -Q trx_payouts,eth_payouts,bnb_payouts,matic_payouts,aah_payouts,klay_payouts -c 1 "
     restart: always
     volumes:
      - /app/opencex/backend:/app
     networks:
    ...
    opencex-balances:
     ...
     image: opencex:latest
     command: bash -c "celery -A exchange worker -l info -n check_balances -Q trx_check_balances,bnb_check_balances,eth_check_balances,matic_check_balances,aah_check_balances,klay_check_balances -c 1 "
     restart: always
     volumes:
      - /app/opencex/backend:/app
     networks:
    ...
    opencex-coin-accumulations:
     ...
     image: opencex:latest
     command: bash -c "celery -A exchange worker -l info -n coin_accumulations -Q trx_accumulations,bnb_accumulations,eth_accumulations,matic_accumulations,aah_accumulations,klay_accumulations -c 1 "
     restart: always
     volumes:
      - /app/opencex/backend:/app
     networks:
    ...
    opencex-token-accumulations:
     ...
     image: opencex:latest
     command: bash -c "celery -A exchange worker -l info -n tokens_accumulations -Q trx_tokens_accumulations,bnb_tokens_accumulations,eth_tokens_accumulations,matic_tokens_accumulations,aah_tokens_accumulations,klay_tokens_accumulations -c 1 "
     restart: always
     volumes:
      - /app/opencex/backend:/app
     networks:
    ...
    opencex-gas:
     ...
     image: opencex:latest
     command: bash -c "celery -A exchange worker -l info -n send_gas -Q trx_send_gas,bnb_send_gas,eth_send_gas,matic_send_gas,aah_send_gas,klay_send_gas -c 1 "
     restart: always
     volumes:
      - /app/opencex/backend:/app
     networks:
